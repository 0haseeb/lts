    ...
    <li class="list-group-item">
        ...
        <div style=" float:right;" class="dropdown dropleft ">
            ...
            <div class="dropdown-menu">
                ...
                <button class="dropdown-item" type="button" data-postid="{{$post['id']}}" data-postbody="{{$post['content']}} " data-toggle="modal" data-target="#editModal"><img src="{{ asset('img/edit.png') }}" width="30px"
                      height="30px">&nbspEdit</button>
                <button class="dropdown-item" data-toggle="modal" data-target="#deleteModal" type="button"><img src="{{ asset('img/delete.png') }}" width="30px" height="30px">&nbsp Delete</button>
                @else
        ...
        <ul class="list-group list-group-flush">
            ...
            <div style="padding-left:30px;">
                ...
                @endif
                <a href="{{ url('google.com') }}" style="padding-left:30px;"><img src="{{ asset('img/share.png') }}" width="30px" height="30px"></a>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{action('PostController@destroy', $post['id'])}}" method="post"> @csrf
                <div class="modal-body">
