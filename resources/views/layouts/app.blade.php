                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <form class="form-inline" method="GET" action="{{action('SearchController@findPosts')}}" enctype="multipart/form-data">
                            <input class="form-control mr-sm-2 bg-dark  " name="search" type="search" placeholder="Find posts and users " aria-label="Search">
                        </form>
                        @endguest
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <h4 style="  position: absolute;right: 2px;top: 2px;  color: #fff; "><b>{{$notifcount}}</b></h4>
                            </a>
