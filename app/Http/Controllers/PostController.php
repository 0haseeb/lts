...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        //add auth user id to list of user ids
        $user_ids[] =$user->id;
        // find posts where user_id is $user_ids, order byt latest and get 10 posts perpage.
        $posts =Post::whereIn('user_id', $user_ids)->orderby('created_at', 'desc')->paginate(10);
