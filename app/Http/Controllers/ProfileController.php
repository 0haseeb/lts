...
class ProfileController extends Controller
{
    ...
    public function show(User $user)
    {
        if ($user) {
            ...
            return view('users/profile', compact('user', 'posts', 'followerscount', 'followingcount', 'Topicscount', 'Postscount', 'Likescount'));
        } else {
            return view('404');
        }
    }
    ...
    public function likedposts(User $user)
    {
        if (!$user==null) {
            ...
            $Postscount= count($user->posts);
            $Likescount= count($user->Likes);
            return view('users/likes', compact('user', 'followerscount', 'followingcount', 'Topicscount', 'Postscount', 'likedposts', 'Likescount'));
        } else {
            return view('404');
        }
    }
